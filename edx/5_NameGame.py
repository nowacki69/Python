...
class Name:
    ...
    def find_printed_name(self):
        # return first and last name with a space between them
        printed_name = self.first_name + " " + self.last_name
        return printed_name
    
    def find_sortable_name(self):
        #return last name, a comma and a space, then first initial
        sorted_name = self.last_name + ", " + self.first_name[0]
        return sorted_name
