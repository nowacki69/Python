...
print(mystery_string_1, "<", mystery_string_2, " -->", mystery_string_1 < mystery_string_2)
print(mystery_string_1.lower(), "<", mystery_string_2.lower(), " -->", mystery_string_1.lower() < mystery_string_2.lower())
