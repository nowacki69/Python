...
print(f"Time/Date Then:    {then}")
print(f'String Output:     {whenever.strftime("%m/%d/%Y %H:%M")}')
print(now.year)
print(now.month)
print(now.day)
print(now.hour)
...
# print(f"Full Date: {delta}")
# print(f"Days: {delta.days}")
# print(f"Minutes: {delta.minute}")
# print(f"Seconds: {delta.second}")
