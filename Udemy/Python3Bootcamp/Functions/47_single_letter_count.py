...
# The first parameter should be a word and the second should be a letter. The function returns
# the number of times that letter appears in the word. The function should be case insensitive
# (does not matter if the input is lowercase or uppercase). If the letter is not found in the word
