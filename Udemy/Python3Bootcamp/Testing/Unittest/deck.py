...
class Deck:
    ...
    def __init__(self):
        self.cards = ["A of Hearts", "2 of Hearts", "3 of Hearts",
                        "4 of Hearts", "5 of Hearts", "6 of Hearts",
                        "7 of Hearts", "8 of Hearts", "9 of Hearts",
                        "10 of Hearts", "J of Hearts", "Q of Hearts",
                        "K of Hearts", "A of Spades", "2 of Spades",
                        "3 of Spades", "4 of Spades", "5 of Spades",
                        "6 of Spades", "7 of Spades", "8 of Spades",
                        "9 of Spades", "10 of Spades", "J of Spades",
                        "Q of Spades", "K of Spades", "A of Diamonds",
                        "2 of Diamonds", "3 of Diamonds", "4 of Diamonds",
                        "5 of Diamonds", "6 of Diamonds", "7 of Diamonds",
                        ...
                        "9 of Clubs", "10 of Clubs", "J of Clubs", "Q of Clubs",
                        "K of Clubs"
                        ]
        Deck.total_cards = 52
    ...
    def _deal(self, num):
        ...
        if num <= Deck.total_cards:
            ...
            for i in range(0, Deck.total_cards):
                new_card = (self.cards.pop())
                cards_dealt.append(new_card)
                Deck.total_cards -= 1
